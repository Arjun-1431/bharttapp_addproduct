...
export default function StepperForm() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-blue-100 via-blue-200 to-blue-300 p-4 flex items-center justify-center">
      {/* Loader Overlay */}
      {loading && (
        <div className="fixed inset-0 z-50 bg-white/80 flex flex-col items-center justify-center pointer-events-auto">
        ...
        {step === 1 && (
          <form onSubmit={handleSubmit} className="space-y-4 mt-4">
            ...
            <div>
              ...
              {errors.standee_type && (
                <p className="text-red-500 text-sm">{errors.standee_type}</p>
              )}
            </div>
            ...
            {shouldShowIcons() && (
              <>
                ...
                {errors.icons && (
                  <p className="text-red-500 text-sm">{errors.icons}</p>
                )}
                ...
                {icons.includes("UPI") && (
                  <div className="mt-4">
                    ...
                    />
                    {errors.upi_qr && (
                      <p className="text-red-500 text-sm">{errors.upi_qr}</p>
                    )}
                  </div>
                )}
                <input
